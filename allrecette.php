...
<body class="">
                    ...
                    <nav class="flex items-center justify-between flex-wrap  ">
                        ...
                        <div id="main-nav" class="w-full flex-grow lg:flex items-center lg:w-auto hidden  ">
                            <div class="sm:flex-grow text-sm lg:flex-grow mt-2 animated jackinthebox xl:flex xl:mr-auto xl:mx-8 items-center">
                                ...
                                <div class="xl:flex">
                                    ...
                                    if (isset($_SESSION['login'])) {
                                        ...
                                        echo '<a href="accueilAdmin.php" id="accueilnav" class="block xl:mb-0 mb-2 lg:inline-block text-md font-bold  hover: mx-2  xl:p-2  rounded-lg">
                                            ADMIN
                                        </a>
                                    ...
                                    <a class="font-semibold whitespace-no-wrap text-white ml-2 xl:ml-0  font-bold text-sm"
                                        href="">
                                    ...
                                    <ul class="absolute left-0 top-0 mt-6 p-2 rounded-lg shadow-lg  z-10 hidden group-hover:block" id="barre">
                                        ...
                                        <a class="px-2 py-1" href="allFavorites.php">
                                            <span class="">Afficher mes favoris</span>
                                        </a>
                                        </li>
                                    </li>
                                </ul>
                                    ...
                                    <a href="moncompte.php" class="block lg:inline-block text-md font-bold mb-4  text-white mt-2 xl:mt-0  hover: mx-2  xl:p-2  rounded-lg">
                                        SHOPPING LIST
                                    </a>
                                        ';
                                    } else {
                                    ...
                                    <a href="allrecette.php" class="block lg:inline-block text-md font-bold   text-white   hover: mx-2  xl:p-2  rounded-lg">
                                    RECETTES
                                </a>
                            ...
                            <div class="xl:flex xl:ml-auto items-center">
                                <div class="flex pl-4 pt-4 xl:pt-0 justify-center">
    ...
    <!-- conteneur -->
    <div class="bg-gray-400  flex-auto sm:px-32 px-10 py-12">
        <div class="max-w-3xl mx-auto relative ">
            <h1 class="text-center font-calibri text-black text-4xl pb-6 "><i class="fas text-orange-400 fa-utensils"></i> Toutes les recettes</h1>
        </div>

        <?php
        foreach ($touteslesrecipe as $result) { ?>

            <div class="xl:flex-auto flex-1  ">

                <!-- Colonne de gauche -->
                <div class="border-4 border-orange-400 w-full bg-gray-100">
                    <div id="barre" class=" text-center text-gray-400">Titre de la recette :
                    ...
                    <div class="border-r text-left h-64">
                ...
                <!-- Colonne de droite -->
                <div class="border-4 border-orange-400 w-full bg-gray-100 mb-16 ">
                    <div>
                        <p class="text-center font-bold mt-16 ">Temps de préparation :</p>
...
<footer class="">
    <div class="bg-orange-400  md:flex ">
        ...
        <div class="border-orange-400">
            <a href="index.php">
                <img src="img/unnamed.jpg" class="mx-auto border-orange-400 border-4 pt-20" alt="la description textuelle de ton image" id="logosite" />
            </a>
        </div>
